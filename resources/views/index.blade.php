    ...
    <table class="border-collapse border border-slate-500 w-full">
        <thead>
            <tr>
                ...
                <th scope="col" class="border border-slate-600 bg-blue-400">Total Count</th>
                ...
                <th scope="col" class="border border-slate-600 bg-blue-400">edit</th>
                <th scope="col" class="border border-slate-600 bg-blue-400">Delete</th>
            ...
            @foreach ($formattedTransactions as $transaction)
                <tr>
                    ...
                    <td class="border border-slate-700">           
                        <form action="{{ route('transaksi.edit', $transaction['id']) }}" method="GET">
                            @csrf
                        
                            <button type="submit" class="btn bg-blue-500 rounded-sm btn-danger btn-sm">Edit</button>
                        </form>
                    </td>
                    ...
                    <td class="border border-slate-700">
                        <form action="{{ route('transactions.destroy', $transaction['id']) }}" method="post">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn bg-red-500 rounded-sm btn-danger btn-sm">Delete</button>
                        </form>
                    </td>
